...
namespace TGF
{
    ...
    public class AIWaypointPatroller : MonoBehaviour
    {
        ...
        public struct WaypointContainer
        {
            ...
            [ShowIf("AllowPathBranch"), AllowNesting]
        ...
        private AgentState _previousState;
        public void Distract()
        {
            _previousState = _agentState;
            _agentState = AgentState.Distracted;
        }
        public void RegainFocus()
        {
            _agentState = _previousState;
            _previousState = AgentState.Idle;
        }
        ...
        private void SetDestinationAndStartWalking()
        {
            ...
            {
                if (_IDModifier == 1 ?
                    (_currentWaypointID + _IDModifier < _waypoints.Count) :
                    (_currentWaypointID + _IDModifier >= 0))
                {
